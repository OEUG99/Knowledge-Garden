...
- # Introduciton
	...
	- ## Core Beliefs
		...
		- ### Noble Eightfold Path
			...
			- **Right Understanding (Samma-ditthi)**: This is an understanding of the Four Noble Truths, the nature of suffering, its causes,  cessation, and the path leading to its cessation.
			  logseq.order-list-type:: number
			- logseq.order-list-type:: number
		-
		-