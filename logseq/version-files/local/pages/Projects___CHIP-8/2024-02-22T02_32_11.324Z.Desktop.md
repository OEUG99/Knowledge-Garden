tags:: [[Programming]] #[[Virtual Machines]] #Emulation #Interpreter #Assembler #[[Game Development]] #CHIP-8
	...
	- ## Project's Structure
		...
		- The stages are as followed:
			...
			- **Stage 3 - Game Design: **
				...
				- This was by far the hardest stage, not because it requires both my emulator and assembler to be perfect, rather because I had to program the game in assembly.  As a result, I had to learn how balance memory management while also designing something fun and feasible for 8-bit retro limitations.